package com.virgo.com.pc.modules.admin.controller;
...
import com.virgo.com.pc.modules.user.service.IUserService;
...
public class AdminManagerController extends PcBaseControllerr {
    ...
    public void loadAllUser(HttpServletRequest request, HttpServletResponse response){
        ...
        JSONObject object;
        if(page<=allPage){
            List<User> users = userService.selectUserByPage(page);
